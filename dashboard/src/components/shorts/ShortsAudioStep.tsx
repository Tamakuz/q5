  ...
  return (
    <div className="p-6 bg-gray-950/80 border border-gray-800 rounded-3xl min-h-full space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white flex items-center gap-2">
              3. Voice-Over & Factory ASMR Studio
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Kelola audio Voice-Over TTS / rekaman suara + efek suara mesin pabrik / ASMR.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900/40 border border-dashed border-gray-800/90 p-12 rounded-2xl text-center space-y-3">
        ...
        <h3 className="text-sm font-bold text-gray-300">Factory Audio & ASMR Studio</h3>
        <p className="text-xs text-gray-500 max-w-md mx-auto">
          Modul mixing audio voiceover, musik latar upbeat/futuristik, dan efek pemotong/mesin otomatis.
        </p>
      </div>
    </div>
  );
