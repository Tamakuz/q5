// dashboard/src/utils/wakuTheme.ts
// Canonical Waku color theme constants.
// All Waku UI accent is emerald green — change colors here and all
// components + subtitle generators update together.

export const WAKU_CAPTION_COLORS = {
...
// ── Tailwind class conventions for Waku step components ──
//
// These patterns are used consistently across all Waku*.tsx files:
//
