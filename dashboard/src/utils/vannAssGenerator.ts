...
export function generateAssSubtitles(
  ...
  const activeAssColor = hexToAssColor(options?.activeColorHex || WAKU_CAPTION_COLORS.activeColorHex);
  const inactiveAssColor = hexToAssColor(options?.inactiveColorHex || WAKU_CAPTION_COLORS.inactiveColorHex);
  const outlineAssColor = hexToAssColor(options?.outlineColorHex || WAKU_CAPTION_COLORS.outlineColorHex);
