...

{
  "concepts": [
    ...
    },
    {
      ...
      "prompt": "YouTube thumbnail artwork in hand-drawn 2D stick-figure style, 16:9 widescreen composition. A stick-figure character with a huge round head and thin limbs, with an exaggerated wide-mouth screaming expression in shock, positioned at the bottom-center. Solid flat lime green background with intense color contrast. High visual clarity, minimal environment. At the top of the frame, prominent bold text overlay reading \"<TEKS OVERLAY 2-3 KATA INDONESIA>\" in bright yellow all-caps text with a thick black outline. Thick hand-drawn outlines, flat color palette, eye-catching mobile YouTube thumbnail layout. Negative Constraints: 3D model, realistic texture, small font, noisy background, gradients."
    }
  ]
}
