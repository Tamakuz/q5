# Knowledge: Strategi Konten & Metrik YouTube Alur Film

Dokumen ini berisi prinsip utama algoritma YouTube yang harus diterapkan dalam pembuatan skrip, judul, thumbnail, dan ritme produksi alur film.
...
### 2. Retention (Daya Tahan Nonton) — *Apakah orang bertahan nonton?*
- **Terjadi setelah video diklik.** YouTube mengukur seberapa lama penonton bertahan.
- **Risiko Detik Ke-10**: Jika penonton keluar di 10 detik pertama, algoritma membaca bahwa ekspektasi dari thumbnail/judul tidak terpenuhi (sinyal buruk → video tenggelam).
- **Prinsip Alur Film**:
  - **Hook Awal Kuat**: 10–30 detik pertama skrip harus langsung mengikat penonton dan memenuhi ekspektasi judul/thumbnail.
  - **Pacing Stabil**: Hindari narasi berliku-liku yang membosankan.
  - **Retention Tinggi**: Sinyal bagi YouTube untuk push video ke audiens yang lebih luas.

---

### 3. Konsistensi — *Apakah YouTube bisa memprediksi ritme channel?*
- Algoritma menyukai channel dengan ritme upload yang terprediksi dan stabil.
- **Risiko Upload Angot-angotan**: Upload mendadak banyak lalu menghilang membuat YouTube ragu mendistribusikan konten.
- **Prinsip Alur Film**:
